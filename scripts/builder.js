...
class Builder {
  ...
  buildPage(mode, file) {
    ...
    dom.querySelector('#modes_buttons_container').set_content(this.buildModesLinks(file, mode))
  ...
  buildModesLinks(fileName, mode) {
    var html = ""

    // if (mode == "guided") {
    //     let href = this.BASE_URL + "guided-indexed" + "/" + fileName
    //     let link = "<a class=\"modes_button\" href=\"" + href + "\">" + "Mostrar sumário" + "</a>" + "<br>"
    //
    //     html += link
    // } else {
    //     let href = this.BASE_URL + "guided" + "/" + fileName
    //     let link = "<a class=\"modes_button\" href=\"" + href + "\">" + "Esconder sumário" + "</a>" + "<br>"
    //
    //     html += link
    // }
